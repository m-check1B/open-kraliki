...
echo "=== RECENT LOGS ===" && \
for d in fixer-orchestrator claude-fixer codex-fixer opencode-fixer kimi-fixer watchdog heartbeat relay; do \
...
rm -f ~/logs/kimi-fixer/kimi-fixer.lock
...
for fixer in claude-fixer codex-fixer opencode-fixer kimi-fixer; do
